    ...
    if (in_array($fileExt, $allowedExtensions) || $fileExt == 'txt') {
        ...
        if (move_uploaded_file($fileTmpName, $filePath)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                header("Location: upload_file.php?st=error");
                exit;
            }
        } else {
            header("Location: upload_file.php?st=error");
...
if (isset($_GET['delete'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        header("Location: upload_file.php?st=deleted");
        exit;
    } else {
        echo "Error: " . mysqli_error($con);
        header("Location: upload_file.php?st=error");
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../styles/data_store/upload_file.css">
