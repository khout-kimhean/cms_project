...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../styles/data_store/view_upload.css">
                                    ...
                                    <?php if (!empty($searchResults)): ?>
                                        ...
                                        foreach ($searchResults as $row):
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_input.php?id=<?php echo $row['id']; ?>">Edit</a> |
                                                    <a
                                                        href="../data_store/view_upload.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                                </td>
