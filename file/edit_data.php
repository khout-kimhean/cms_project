...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $sql = "SELECT filename, title,  description FROM upload_file WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE upload_file SET  title = ?,  description = ? WHERE id = ?";
    $stmt = $conn->prepare($sql);
                ...
                <div class="wrapper">
                    <div class="back_button">
                        <a href="../file/view_file.php" class="back-button">
                            <i class="fa fa-chevron-circle-left" style="font-size: 20px">Back</i>
                        </a>
                    </div>
